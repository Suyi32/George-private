...
params = {
        'batch_size': 50,
        'epochs': 50000,
        'path': "pppo_27_nodeused_80_" + str(hyper_parameter['batch_C_numbers']),
...
def train(params):
    ...
    while epoch_i < params['epochs']:
        ...
        list_check = 0 #list_check_sum + list_check_coex + list_check_per_app
        ...
        list_check += ((tput_breakdown < 0.80) * tput_state).sum()
...
def batch_data(NUM_CONTAINERS, NUM_NODES):
    ...
    npzfile = np.load("data/batch_set_cpo_27node_" + str(50) + '.npz')
...
def main():
    ...
    params['path'] = "cpo_27_nodeused_80_" + str(hyper_parameter['batch_C_numbers'])
