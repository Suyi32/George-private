...
class PolicyGradient:
    def __init__(self,
        ...
        self.tput_persisit = []
        self.episode = []
        self.transfer_len_batch = []
        self.transfer_len_persist = []
    ...
    def store_training_samples_per_episode(self, s, a, r, rt):
    ...
    def store_tput_per_episode(self, tput, episode):
        ...
        # self.transfer_len_batch.append(transfer_len)
        # self.transfer_len_persist.append(transfer_len)

    def learn(self, epoch_i, entropy_weight, IfPrint=False, alpha = 0.5):
        # discounted_ep_rs_norm_1 = self._discount_and_norm_rewards()
        # discounted_ep_rs_norm_2 = self._discount_and_norm_rewards_rt()
        discounted_ep_rs_norm = self._discount_and_norm_rewards()#alpha*discounted_ep_rs_norm_1+(1-alpha)*discounted_ep_rs_norm_2
