...
from testbed_new.cluster_env import LraClusterEnv
from testbed_new.PolicyGradient_PCPO_PPO_3layers import PolicyGradient
print("Brain: PolicyGradient_PCPO_PPO_3layers")
print("using PPPO")
import argparse
from testbed_new.simulator.simulator import Simulator
...
def rl_sample(observation, source_batch_, index_data, RL_1, RL_2, RL_3, env, params):
    ...
    return observation_third_layer_aggregation, observation_episode_1, action_episode_1, observation_episode_2, action_episode_2, observation_episode_3, action_episode_3
...
def train(params):
    ...
    while epoch_i < params['epochs']:
        ...
        for sample_idx in range(len(batch_sample_results)):
            env.state = batch_sample_results[sample_idx][0].copy()
