...
class PolicyGradient:
    ...
    def learn_vio (self, epoch_i, entropy_weight, IfPrint=False):
        ...
        if IfPrint:
            ...
            print("CPO(learn_vio): epoch: %d, tput: %f, self.ep_ss: %f, safe_mean: %f, entro: %f, loss: %f" % (
    ...
    def learn(self, epoch_i, entropy_weight, Ifprint=False):
        ...
        if Ifprint:
            print("CPO(learn): epoch: %d, tput: %f, self.ep_ss: %f, safe_mean: %f, new_kl_divergence: %f, new_safety_loss: %f, new_loss: %f, entro: %f" % (
    ...
    def get_weights(self):
        return self.sess.run(self.flat_params_op)

    def set_weights(self, weights):
        self.sess.run(self.params_assign_op, feed_dict={self.new_params: weights})
